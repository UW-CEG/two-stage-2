...
* The AIC *increases* for `sex_mod3.b`, so we should use `sex_mod3.a` as our final model (summarized above). This means that we are retaining the `sex_id` parameter in our model.
