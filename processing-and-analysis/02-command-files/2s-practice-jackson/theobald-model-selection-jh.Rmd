...
```{r}
sex_mod3.a <- lm(final_c ~ sex_id + satm_c + satv_c + aleksikc_c + hsgpa_c, data = master_true)
summary(sex_mod3.a)
...
```{r}
sex_mod3.b <- lm(final_c ~ satm_c + satv_c + aleksikc_c + hsgpa_c, data = master_true)
summary(sex_mod3.b)
...
```{r}
fgn_mod3.a <- lm(final_c ~ fgn_id + satm_c + satv_c + aleksikc_c + hsgpa_c, data = master_true)
summary(fgn_mod3.a)
...
```{r}
fgn_mod3.b <- lm(final_c ~ satm_c + satv_c + aleksikc_c + hsgpa_c, data = master_true)
summary(fgn_mod3.b)
...
```{r}
fgn_mod3.c <- lm(final_c ~ satm_c + aleksikc_c + hsgpa_c, data = master_true)
summary(fgn_mod3.c)
...
```{r}
urm_mod3 <- lm(final_c ~ experiment1 + urm_id + satm_c + satv_c + aleksikc_c + hsgpa_c, data = master_true)
```
...
```{r}
urm_mod3.a <- lm(final_c ~ experiment1 + satm_c + satv_c + aleksikc_c + hsgpa_c, data = master_true)
summary(urm_mod3.a)
...
```{r}
urm_mod3.b <- lm(final_c ~ satm_c + satv_c + aleksikc_c + hsgpa_c, data = master_true)
summary(urm_mod3.b)
...
```{r}
urm_mod3.c <- lm(final_c ~ satm_c + aleksikc_c + hsgpa_c, data = master_true)
summary(urm_mod3.c)
